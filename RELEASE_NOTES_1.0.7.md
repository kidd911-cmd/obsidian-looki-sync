# Looki Sync v1.0.7 Release Notes
...
- 其余功能与 v1.0.6 完全一致（笔记同步、图片/视频下载、ForYou 同步等）。
...
Built on v1.0.6, this is a small update:
...
- Everything else is identical to v1.0.6 (note sync, image/video download, ForYou sync, etc.).
